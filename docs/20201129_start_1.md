...
![Raspberry Pi 4 picture!](/docs/assets/images/shining-in-dark-picture1.png?raw=true =200x "Shining in dark layout")
...
![Raspberry Pi 4 with LED!](/docs/assets/images/shining-in-dark-picture2.png?raw=true =150x "Shining in dark")
